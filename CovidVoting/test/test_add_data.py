...
class TestAddData(unittest.TestCase):
    ...
    # allstates, "coviddataand2020Election.csv")
        add_data('data/coviddataand2020Election.csv', 'data/raw_7_keystates_covid_voting_issue_poll.csv',
    ...
    def test_oneshot(self):
        ...
        Returns:
            ...
            False: Test failed
        """
        self.assertEqual(add_data('data/coviddataand2020Election.csv',
